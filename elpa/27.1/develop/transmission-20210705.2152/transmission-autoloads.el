...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "transmission" '("define-transmission-" "download>?" "eta>=?" "file-" "percent-done>?" "progress>?" "ratio>?" "size" "transmission-" "upload>?")))
